...
class RLState
  ...
  chunk_performance: Optional[Dict[str, Dict[str, Any]]] = field(default_factory=dict)
  # chunk_id: {correct: int, incorrect: int, attempts: int, last_attempt: str}
  # Format: {"chunk_0": {"correct": 3, "incorrect": 1, "attempts": 4, "last attempt": "2025-11-17T..."}, ...}
